...
public class PermissionsUtil {
    ...
    public static final class Permission {
        private static final List<String> sCalendars = new ArrayList<>(2);//日历
        private static final List<String> sCameras = new ArrayList<>(1);//相机
        private static final List<String> sContactes = new ArrayList<>(3);//联系人
        private static final List<String> sLocations = new ArrayList<>(2);//地点
        private static final List<String> sMicrophones = new ArrayList<>(1);//麦克风
        private static final List<String> sPhones = new ArrayList<>(7);//电话
        private static final List<String> sSensorses = new ArrayList<>(1);//传感器
        private static final List<String> sSmses = new ArrayList<>(5);//短信
        private static final List<String> sStorages = new ArrayList<>(2);//存储
    ...
    public void request(Object object, int requestCode, String... permissions) {
        ...
        boolean b = notGrantedAllPermissions(getActivity(object), permissions);
        if (needRequest() && notGrantedAllPermissions(getActivity(object), permissions)) {
            ...
            List<String> strings = stringArrayToList(permissions);
